...
As Wings também devem ter uma criada para seu FQDN. Consulte a página de documentação [Configurar SSL](/docs/3%20-%20Jexactyl/3%20-%20Servidor%20Web/setup-ssl.mdx) para saber como criar esses certificados antes de continuar.
:::
