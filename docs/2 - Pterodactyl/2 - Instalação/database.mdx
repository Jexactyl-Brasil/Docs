...
sidebar_position: 3
---
import CustomGen from '@site/src/components/GenPassord';
...
:::info Informação
No botão abaixo é possivel gerar senhas aleatorías de 32 caracteres, caso tenha queira usar uma senha unica
<CustomGen />
:::